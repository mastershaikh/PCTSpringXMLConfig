...
public class DealerDAOI implements DealerDAO {
	...
	public void updateCylinderCount(String dealerId) {
		Session session = sessionFactory.getCurrentSession();
		try {
			String hql ="select cylinderType from Cylinder where usageStatus=:dId";
			...
			total = o2+n2+air;
			hql = "update DealerDetails set o2No=:o2,n2No=:n2,airNo=:air,totalCylindersTaken=:total where dealerId=:dId";
